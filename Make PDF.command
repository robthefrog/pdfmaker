...
#  Windows launcher (Make PDF.bat).
# ============================================================

# Run from THIS folder so the whole "PDF Maker" folder can be moved or copied
# anywhere and still work (handles spaces in the path).
...
exec python3 "$DIR/launcher.py" make "$@"
